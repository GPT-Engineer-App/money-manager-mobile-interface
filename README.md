# money-manager-mobile-interface
...
Faça algo mais simples para nao ficar muito grande o codigo
...
```sh
git clone https://github.com/GPT-Engineer-App/money-manager-mobile-interface.git
cd money-manager-mobile-interface
npm i
```
